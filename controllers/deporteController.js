...
exports.store = async (req, res) => {
    try {
        ...
        if(buscarDeporte) {
            res.status(400).send("El nombre ya existe en la base de datos");
        }
        else {
...
exports.update = async (req, res) => {
    try {
        ...
        if(deporte) {
            res.json({ msg: "se actualizo correctamente", deporte: deporte });
        }
        else {
...
exports.delete = async (req, res) => {
    try {
        ...
        if(! deporte){
            res.send("No se encontro el deporte");
        }
        else {
            res.json({ msg: 'Deporte eliminado', deporte: deporte });
        }
